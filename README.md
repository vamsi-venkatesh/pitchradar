...
[![CI](https://github.com/vamsi-venkatesh/pitchradar/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/vamsi-venkatesh/pitchradar/actions/workflows/ci.yml)
...
PitchRadar runs as a privately deployed single-operator system (daily collection cycles, nightly restore-verified backups). This repository is the sanitized engineering core: client identity, deployment infrastructure and the full curated source registry are removed. This repository is a sanitized public snapshot of a privately developed and operated system; private development history is intentionally not published.
